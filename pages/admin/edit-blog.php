...
<head>
    ...
    <title>Mude Capital | Edit Blog</title>
                    ...
                    <ul id="navbar-navlist"
                      ...
                      <desc>Created with Sketch.</desc> -->
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            ...
                                            <rect id="Rectangle-7" fill="currentColor" x="4" y="4" width="7" height="7"
                                                rx="1.5"></rect>
                                            <path
                        ...
                        <li class="nav-item">
                                ...
                                <div class="flex items-center">
                                    <div class="shrink">
                                        <div class="h-8 w-8 me-2">
                                            <img src="/public/assets/images/avatars/amos.jpg"
                            ...
                            <div id="innerPageDropdownMenu"
                                ...
                                <div class="nav-item rounded hover:bg-slate-100 transition-all">
                                    <a class="nav-link !p-2" href="#">
                                        <svg class="h-4 w-4 me-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round"
                                            class="feather feather-aperture icon icon-xxs me-1 icon-dual">
                                ...
                                <form action="/logout" method="post"
                                    class="nav-item rounded hover:bg-slate-100 transition-all">
                        ...
                        <a href="/admin/post-blog" class="nav-link">
                            <span class="shrink-0 me-2">
                                <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
                                    ...
                                    <title>Stockholm-icons / Text / Article</title>
                                    <desc>Created with Sketch.</desc>
                                    <g id="Stockholm-icons-/-Text-/-Article" stroke="none" stroke-width="1" fill="none"
                                        fill-rule="evenodd">
                                        <rect id="bound" x="0" y="0" width="24" height="24"></rect>
                                        <rect id="Rectangle-20" fill="currentColor" x="4" y="5" width="16" height="3"
                                            rx="1.5"></rect>
                                        <path
                                            d="M5.5,15 L18.5,15 C19.3284271,15 20,15.6715729 20,16.5 C20,17.3284271 19.3284271,18 18.5,18 L5.5,18 C4.67157288,18 4,17.3284271 4,16.5 C4,15.6715729 4.67157288,15 5.5,15 Z M5.5,10 L12.5,10 C13.3284271,10 14,10.6715729 14,11.5 C14,12.3284271 13.3284271,13 12.5,13 L5.5,13 C4.67157288,13 4,12.3284271 4,11.5 C4,10.6715729 4.67157288,10 5.5,10 Z"
                                            id="Combined-Shape" fill="currentColor" opacity="0.3"></path>
      ...
      tinymce.init({
        ...
        <div class="flex flex-col w-full items-center justify-center gap-4 p-2 md:p-5">
            ...
            <form id="frm-edit-blog" enctype="multipart/form-data" class="flex flex-col md:w-10/12"
                action="/api/blogs/update" method="post">
                <div class="mb-2">
                    <label for="exampleInputEmail1" class="block text-sm font-medium mb-1 text-gray-600">Blog Title
                        <span class="text-red-500">*</span></label>
                    <input id="blog-title" type="text" required name="title" value="<?= $blog->title ?>"
                ...
                <div class="mb-2">
                    <label for="exampleInputEmail1" class="block text-sm font-medium mb-1 text-gray-600">Blog
                        Category
                        <span class="text-red-500">*</span></label>
                    <input id="blog-title" type="text" required name="category" value="<?= $blog->category ?>"
                        class="py-2 px-4 leading-6 block w-full border-gray-300 rounded text-sm focus:border-gray-300 focus:ring-0"
                        id="exampleInputEmail1" placeholder="Blog Category" />
                </div>
                <div class="mb-2">
                    <label for="exampleInputEmail1" class="block text-sm font-medium mb-1 text-gray-600">Blog Author
                        <span class="text-red-500">*</span></label>
                    <input id="blog-author" type="text" required name="author" value="<?= $blog->author ?>"
                        class="py-2 px-4 leading-6 block w-full border-gray-300 rounded text-sm focus:border-gray-300 focus:ring-0"
                ...
                <div class="mb-5">
                    ...
                    <input id="blog-desc" type="text" required name="description" value="<?= $blog->description ?>"
                        class="py-2 px-4 leading-6 block w-full border-gray-300 rounded text-sm focus:border-gray-300 focus:ring-0"
