    ...
    <head>
      <meta charset="utf-8" />
      <title>Mude Capital | Là où vos finances prennent vie.</title>
      ...
      <meta content="dev.binmulindi6" name="author" />
      ...
      <!-- <script src="https://cdn.tiny.cloud/1/ofzzc0lfzdtbw1o3ymvs0c9dfqf5qpg5gqetr2qc5dgdtmxs/tinymce/7/tinymce.min.js" referrerpolicy="origin"></script> -->
    ...
    <body>
            ...
            <div class="hidden lg:block mx-auto grow">
              <ul id="navbar-navlist" class="grow flex flex-col lg:flex-row lg:items-center lg:justify-center mt-4 lg:mt-0">
                <li class="nav-item pe-4">
                  <a class="nav-link flex items-center font-medium py-2 px-4 lg:py-0 text-primary" href="/dashboard">
                ...
                <li class="nav-item pe-4">
                  <a class="nav-link flex items-center font-medium py-2 px-4 lg:py-0 text-gray-700 hover:text-primary transition-all" href="/admin/blog">
                    <span class="shrink-0 me-2">
                      <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <span class="grow">Blogs</span>
                  </a>
                </li>
                <li class="nav-item pe-4">
                  <a class="nav-link flex items-center font-medium py-2 px-4 lg:py-0 text-gray-700 hover:text-primary transition-all" href="/admin/post-blog">
                    <span class="shrink-0 me-2">
                      <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <span class="grow">Post Blog</span>
                  </a>
                </li>
                <!-- <li class="nav-item pe-4">
                <a
                  class="nav-link flex items-center font-medium py-2 px-4 lg:py-0 text-gray-700 hover:text-primary transition-all"
                  href="index"
                >
                  <span class="shrink-0 me-2">
                    <svg
                    ...
                    <div class="flex items-center">
                      <div class="shrink">
                        <div class="h-8 w-8 me-2">
                          <img src="/public/assets/images/avatars/amos.jpg" class="avatar h-full w-full rounded-full me-2" alt="" />
                        </div>
                      </div>
                      <div class="hidden lg:block grow ms-1 leading-normal">
                        <span class="block text-sm font-medium">MudeCapital</span>
                  ...
                  <div id="innerPageDropdownMenu" class="hidden opacity-0 mt-4 fc-dropdown-open:opacity-100 fc-dropdown-open:translate-y-0 translate-y-3 origin-center transition-all bg-white rounded-lg shadow-lg border p-2 w-48 space-y-1.5">
                    ...
                    <div class="nav-item rounded hover:bg-slate-100 transition-all">
                      <a class="nav-link !p-2" href="#">
                        <svg class="h-4 w-4 me-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user icon icon-xxs me-1 icon-dual">
                    ...
                    <div class="nav-item rounded hover:bg-slate-100 transition-all">
                      <a class="nav-link !p-2" href="#">
                        <svg class="h-4 w-4 me-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-settings icon icon-xxs me-1 icon-dual">
                    ...
                    <div class="nav-item rounded hover:bg-slate-100 transition-all">
                      <a class="nav-link !p-2" href="#">
                        <svg class="h-4 w-4 me-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-aperture icon icon-xxs me-1 icon-dual">
                    ...
                    <!-- Dropdown item -->
                    <form action="/logout" method="post" class="nav-item rounded hover:bg-slate-100 transition-all">
                      <button type="'submit" class="nav-link !p-2" href="#">
                        <svg class="h-4 w-4 me-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-unlock icon icon-xxs me-1 icon-dual">
        ...
        <div class="flex flex-col h-full divide-y-2 divide-gray-200">
          ...
          <div class="p-6 overflow-scroll h-full">
            <ul class="navbar-nav flex flex-col gap-2" data-fc-type="accordion">
              <!-- Home Page Link -->
              <li class="nav-item">
                <a href="/dashboard" class="nav-link"><span class="shrink-0 me-2">
                    <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                      <title>Stockholm-icons / Layout / Layout-4-blocks</title>
                      <desc>Created with Sketch.</desc>
                      <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                  ...
                  <span class="grow">Dashboard</span></a>
              </li>
              ...
              <li class="nav-item">
                <a href="/admin/blog" class="nav-link">
                  ...
                  <span class="grow">Blogd</span>
                </a>
              </li>

              <!-- Home Page Link -->
              <li class="nav-item">
                <a href="/admin/post-blog" class="nav-link">
                  <span class="shrink-0 me-2">
                    <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                      <title>Stockholm-icons / Text / Article</title>
                      <desc>Created with Sketch.</desc>
          ...
          <div class="px-6 py-4 flex items-center">
            <button class="bg-primary w-full text-white p-3 rounded flex items-center justify-center text-sm">
              Download
            </button>
          </div>
        </div>
      ...
      tinymce.init({
        ...
        <div class="flex flex-col w-full items-center justify-center gap-4 p-2 md:p-5">
          ...
          <span style="font-size: 32px;" class="text-10  font-bold">Edit Blog</span>
          <div style=" background-image: url('/public/assets/images/<?= $blog->cover ?>');
                            height: 250px;
          ...
          <form id="frm-edit-blog" enctype="multipart/form-data" class="flex flex-col md:w-10/12" action="/api/blogs/update" method="post">
            <div class="mb-2">
              <label for="exampleInputEmail1" class="block text-sm font-medium mb-1 text-gray-600">Blog Title
            ...
            <div class="mb-2">
              <label for="exampleInputEmail1" class="block text-sm font-medium mb-1 text-gray-600">Blog
                Category
                <span class="text-red-500">*</span></label>
              <input id="blog-title" type="text" required name="category" value="<?= $blog->category ?>" class="py-2 px-4 leading-6 block w-full border-gray-300 rounded text-sm focus:border-gray-300 focus:ring-0" id="exampleInputEmail1" placeholder="Blog Category" />
            </div>
            <div class="mb-2">
              <label for="exampleInputEmail1" class="block text-sm font-medium mb-1 text-gray-600">Blog Author
                <span class="text-red-500">*</span></label>
            ...
            <div class="mb-2">
              <label for="exampleInputEmail1" class="block text-sm font-medium mb-1 text-gray-600">Blog Cover
                <span class="text-red-500">*</span></label>
            ...
            <div class="grow">
              <div class="flex items-center gap-3">
                <div class="inline-flex items-center">
                  <a href="/dashboard">Dashboard <i class="fa-solid fa-minus text-sm"></i></a>
                </div>
                <div class="inline-flex items-center">
                  <a href="mudecapital.com">Website <i class="fa-solid fa-minus text-sm"></i></a>
                </div>
                <div class="inline-flex items-center">
                  <a href="my.mudecapital.com">App <i class="fa-solid fa-minus text-sm"></i></a>
                </div>
                <div class="inline-flex items-center">
                  <a href="admin.mudecapital.com">Admin Side</i></a>
                </div>
              </div>
            </div>
            <div>
